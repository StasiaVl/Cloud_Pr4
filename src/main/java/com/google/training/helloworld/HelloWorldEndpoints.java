...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetByNameSurname", path = "greetByNameSurname", httpMethod = HttpMethod.GET)
    
    public HelloClass greetByNameSurname (@Named("name") String name, @Named("surname") String surname, @Named("times") int times) {
        return new HelloClass(name,surname,times);
    }
}
